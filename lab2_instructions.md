...
Encryption works in a similar fashion. Alice can send an encrypted message to Bob
...
Another recommended way of establishing the client's identity is using the same
